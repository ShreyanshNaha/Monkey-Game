...
function setup(){
 createCanvas(600,300);
  ...
  bg=createSprite(300,200,160,160);
  bg.addImage(BG);
  bg.scale=2  ;  
  ...
  ground = createSprite(500,340     ,900,150);
  ground.scale = 1;
...
function draw(){
  ...
  if (gameState === END){
    ...
    stroke("black")
    textSize(30);
    text("G A M E  O V E R  ! ! !", 170, 170);
    fill("black");
    textSize(15);
    text("P r e s s  ' r '  T o   P l a y   A g a i n", 180, 200);
